...
class ProductController extends Controller
{
    public function show()
    {
        ...
        // dd($productList);
        return view('dashboard/eCommerce/products/products', ['productList' => $products]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('product_images')) {
            foreach ($request->file('product_images') as $image) {
                ...
                $path = $image->move('/assets/product', $filename); // Store image in storage/app/public/product_images
                $imagePaths[] = $path;
            }
        }
